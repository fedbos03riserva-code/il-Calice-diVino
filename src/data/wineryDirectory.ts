...
export const wineries: Winery[] = [
  ...
  },
  {
    ...
    annoFondazione: 1960,
    ettari: 22,
    capacitaProduttiva: 1100,
    denominazioni: ["Bonarda DOC", "Buttafuoco DOC", "Cortese DOC", "Pinot Nero DOC"],
    tipologie: ["Rosso", "Bianco", "Spumante"],
    certificazioni: ["Bio EU", "ISO 22000"],
    esporta: true,
    paesiServiti: ["Germania", "Svizzera", "USA", "Belgio"],
    lingueTeam: ["IT", "EN", "DE"],
    incoterms: ["EXW", "FOB", "CIF"],
    moq: 72,
    prezzoFOB: 12.5,
    contatti: { email: "export@beria-vini.it", telefono: "+39 0385 88345", sito: "beria-vini.it" },
    descrizione: "Cantina familiare biologica a Godiasco, 22 ettari. Specialista Bonarda e Buttafuoco. Export in 4 paesi europei. Posizionata nella valle Staffora, microclima unico con escursioni termiche marcate.",
    exportReady: true,
    coordinate: { x: 56, y: 52 },
  },
  {
    id: "WIN014",
    nome: "Cabanon",
    ...
    annoFondazione: 1995,
    ettari: 14,
    capacitaProduttiva: 650,
    denominazioni: ["Pinot Nero DOC", "Metodo Classico DOCG", "Riesling DOC"],
    tipologie: ["Spumante", "Bianco", "Rosso"],
    certificazioni: ["Bio EU", "Vegan"],
    esporta: false,
    paesiServiti: [],
    lingueTeam: ["IT", "EN"],
    ...
    moq: 48,
    prezzoFOB: 15.0,
    contatti: { email: "info@cabanon.it", telefono: "+39 0385 88367", sito: "cabanon.it" },
    descrizione: "Microcantina artigianale a Godiasco, 14 ettari bio e vegan. Riesling di altura e Metodo Classico da Pinot Nero. Produzione limitata, alta qualita. Potenziale export alto per nicchie premium.",
    exportReady: false,
    coordinate: { x: 58, y: 50 },
  },
];
